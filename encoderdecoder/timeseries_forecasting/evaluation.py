...
from timeseries_forecasting.model import TimeSeriesForecasting
from timeseries_forecasting.training import split_df, Dataset
...
def evaluate(
    ...
    full_groups = [
        grp for grp in groups if grp_by_train.get_group(grp).shape[0] > context_size
    ]
