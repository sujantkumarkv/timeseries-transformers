...
python timeseries_forecasting/data_utils.py --csv_path "data/data.csv" \
...
python timeseries_forecasting/training.py --data_csv_path "data/processed_data.csv" \
...
python timeseries_forecasting/evaluation.py --data_csv_path "data/processed_data.csv" \
                                             --feature_target_names_path "data/config.json" \
...
python timeseries_forecasting/plot_images.py